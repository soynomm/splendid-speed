	...
	public function register_services(): void {
		...
		add_action('admin_enqueue_scripts', function($hook) {
		   if($hook === 'settings_page_splendid-speed') {
			   wp_enqueue_style('splendid-speed', SPLENDID_SPEED_DIR_URL . 'assets/css/admin.css', [], '1.3.1');
			   wp_enqueue_script('splendid-speed-admin-page', SPLENDID_SPEED_DIR_URL . 'assets/js/admin.js', [], '1.3.1', true);
		   }
		});
